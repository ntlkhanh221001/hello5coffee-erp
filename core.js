...
(function() {
  ...
  // ──────────────────────────────────────────────
  // 11. OVERRIDE handleLogin SAU KHI TẤT CẢ SCRIPT ĐÃ CHẠY
  //     Dùng window.load (sau DOMContentLoaded) để đảm bảo
  //     override được hàm handleLogin của từng trang
  // ──────────────────────────────────────────────
  window.addEventListener('load', function() {
    // Override handleLogin & handleLogout với unified version
