...
(function() {
  ...
  window.addEventListener('DOMContentLoaded', function() {
    ...
    // Override handleLogin & handleLogout NGAY TẠI ĐÂY
    // (không dùng window.load để tránh bị page script override lại)
  ...
  // ──────────────────────────────────────────────
  // 11. window.load — auto-login từ session + override lần nữa phòng page ghi đè
  // ──────────────────────────────────────────────
  window.addEventListener('load', function() {
    // Override lại lần nữa phòng page script chạy sau DOMContentLoaded ghi đè
    window.handleLogin  = _unifiedHandleLogin;
    window.handleLogout = _unifiedHandleLogout;
    ...
    console.log('H5C Core v2: Ready ✅ — handleLogin unified, Google Sans loaded');
  });
